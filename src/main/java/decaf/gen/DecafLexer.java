...
public class DecafLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOOL", "BREAK", "IMPORT", "CONTINUE", "ELSE", "FOR", "WHILE", "IF", 
			"INT", "RETURN", "LEN", "VOID", "LCURLY", "RCURLY", "LSQUARE", "RSQUARE", 
			"LPAREN", "RPAREN", "COMMA", "SEMI", "INC", "DEC", "ADD_EQUAL", "SUB_EQUAL", 
			"ADD", "SUB", "MULT", "DIV", "MOD", "EQUAL", "NOT", "LT", "LTE", "GT", 
			"GTE", "NEQ", "EQ", "AND", "OR", "QUES", "COLON", "WHITE_SPACE", "LINE_COMMENT", 
			"BLOCK_COMMENT", "INT_LITERAL", "HEX_LITERAL", "BOOL_LITERAL", "ValidAlphaNumeric", 
			"ValidAlpha", "STRING_LITERAL", "CHAR_LITERAL", "IDENTIFIER"
		};
	}
